...
class COCO:
    ...
    def createIndex(self):
        ...
        for ann in self.dataset:
            ...
            imgToAnns[ann['image_id']] += self.reorder_ann(ann)
            imgId.append(ann['image_id'])
        print ('index created!')
    
        self.imgToAnns = imgToAnns
        self.imgId = imgId
    
    def reorder_ann(self, ann):
        res = list()
        if type(ann['caption']) == list:
            for i in range(len(ann['caption'])):
                cap = ann['caption'][i]
                single = {'image_id': ann['image_id'], 'id:': i, 'caption': cap}
                res.append(single)
        else:
            res.append(ann)
        return res
